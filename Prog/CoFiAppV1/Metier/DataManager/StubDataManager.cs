...
namespace Metier.DataManager
{
    public class StubDataManager : IDataManager
    {
        ...
        public IEnumerable<Film> ChargementFilms()
        {
            ...
            Film forrest = new Film("Forrest Gump", 1994, "Film dramatique, racontant l'histoire d'un homme à travers l'histoire de l'amérique", filmForrest, Tag.Drame, Tag.Comedie_Dramatique);
            films.Add(forrest);
